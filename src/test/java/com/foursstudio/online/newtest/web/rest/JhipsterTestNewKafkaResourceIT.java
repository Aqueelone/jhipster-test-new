...
public class JhipsterTestNewKafkaResourceIT {
    ...
    @Autowired
    private JhipsterTestNewKafkaProducer producer;

    @Autowired
    private JhipsterTestNewKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        JhipsterTestNewKafkaResource kafkaResource = new JhipsterTestNewKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/jhipster-test-new-kafka/publish?message=test"))
