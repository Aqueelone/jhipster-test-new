package com.foursstudio.online.newtest.config;
...
public class CacheConfiguration {
        ...
        log.info("Defining Infinispan Global Configuration");
            if (this.registration == null) { // if registry is not defined, use native discovery
                ...
                return () -> GlobalConfigurationBuilder
                    .defaultClusteredBuilder().defaultCacheName("infinispan-jhipsterTestNew-cluster-cache").transport().defaultTransport()
                    .addProperty("configurationFile", jHipsterProperties.getCache().getInfinispan().getConfigFile())
                    .clusterName("infinispan-jhipsterTestNew-cluster").globalJmxStatistics()
                ...
                return () -> GlobalConfigurationBuilder
                    .defaultClusteredBuilder().defaultCacheName("infinispan-jhipsterTestNew-cluster-cache").transport()
    ...
    public InfinispanCacheConfigurer cacheConfigurer(JHipsterProperties jHipsterProperties) {
        ...
        return manager -> {
            ...
            Stream.of(com.foursstudio.online.newtest.repository.UserRepository.USERS_BY_LOGIN_CACHE, com.foursstudio.online.newtest.repository.UserRepository.USERS_BY_EMAIL_CACHE)
